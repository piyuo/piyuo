...
gau(){return"Bahasa"},
gaw(){return"Telefon anda kini boleh menggunakan AI untuk mengenal pasti pejalan kaki."},
gav(){return"Tidak memerlukan internet. Tidak perlu mengira orang secara manual dengan pengira tradisional. Hanya tetapkan telefon anda untuk menjejak lalu lintas pejalan kaki secara automatik."},
...
gau(){return"Bahasa"},
gaw(){return"Telefon bimbit anda kini boleh menggunakan AI untuk mengenal pasti pejalan kaki."},
gav(){return"Tidak perlu internet. Tidak perlu mengira orang secara manual dengan alat pengira tradisional. Hanya sediakan telefon bimbit anda untuk mengesan lalu lintas pejalan kaki secara automatik."},
