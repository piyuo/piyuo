...
gav(){return"Jou foon kan nou KI gebruik om voetgangers te herken."},
gau(){return"Geen internet benodig nie. Geen behoefte om mense handmatig te tel met 'n tradisionele klikker nie. Stel net jou foon op om outomaties verbygaande voetgangersverkeer te monitor."},
...
y(A.nB,C.r)})()
B.a6(b.typeUniverse,JSON.parse('{"nB":{"r":[]}}'))};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_27",e:"endPart",h:b})})($__dart_deferred_initializers__,"DsumhXWKeaPLjFN7h7UBXr0g9Ck=");