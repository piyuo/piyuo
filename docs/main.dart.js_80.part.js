...
gav(){return"Telefonen din kan n\xe5 bruke AI til \xe5 gjenkjenne fotgjengere."},
gau(){return"Ingen internett n\xf8dvendig. Ingen behov for \xe5 telle personer manuelt med en tradisjonell klikker. Bare sett opp telefonen din til \xe5 automatisk spore forbipasserende fotgjengertrafikk."},
...
y(A.p7,C.r)})()
B.a6(b.typeUniverse,JSON.parse('{"p7":{"r":[]}}'))};
((a,b)=>{a[b]=a.current
a.eventLog.push({p:"main.dart.js_80",e:"endPart",h:b})})($__dart_deferred_initializers__,"td3at3+omGlqo8uH5dNnTvpZwDo=");