...
gaO(){return"24/7 na Pagsubaybay"},
gaP(){return"Tingnan ang bilang ng mga naglalakad sa anumang oras."},
gaQ(){return"Sabayang Pagsubaybay ng Maraming Bagay"},
gaR(){return"Sabay-sabay na bilangin ang mga taong naglalakad, mga sasakyan, bisikleta, at iba pa"},
gaS(){return"Pasadyang Detection Zones"},
gaT(){return"Magtakda ng pasadyang detection zones para bilangin ang mga dumadaan sa mga tiyak na lugar."},
gaU(){return"Nababagong Counting Modes"},
gaV(){return"Piliin kung bilangin ang mga bagong lumilitaw na bagay sa loob ng detection zone, o iyong mga nananatiling nakatayo."},
