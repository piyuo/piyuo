...
class LocalizationJa extends Localization {
  ...
  String get index_video_desc =>
      'インターネット接続不要。従来のカウンターで手動で人数を数える必要なし。スマートフォンを設定するだけで、通行する人の流れを自動的に追跡できます。';
  ...
  String get index_desktop_desc =>
      'デスクトップ版も提供しています。iOS/Android/Mac/Windowsに対応しており、モバイルデバイスとウェブカメラ付きのデスクトップの両方を利用できます。デスクトップ版はさらに複数のビデオソースをサポートし、複数のストリームから同時にカウントすることが可能です。';
  ...
  String get index_desktop2_desc =>
      'モバイルデバイスのカメラに加えて、録画されたビデオファイル、ウェブカム入力、RTSPなどのインターネットライブストリームもサポートしています。これにより、既存のデバイスに接続して、すぐに交通流の測定を開始できます。';
  ...
  @override
  String get app_desc =>
      'どれだけの人が通過するか知りたいですか？このアプリはスマートフォンのカメラを使用して、歩行者をインテリジェントに識別し、自動的にカウントします。手動入力は不要です。面倒なカウント作業にさよならして、交通の流れを簡単にモニタリングしましょう。';
