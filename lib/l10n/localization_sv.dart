...
class LocalizationSv extends Localization {
  ...
  String get index_video_title =>
      'Din telefon kan nu använda AI för att känna igen fotgängare.';

  @override
  String get index_video_desc =>
      'Ingen internetanslutning krävs. Ingen manuell räkning med traditionell räknare behövs. Ställ bara in din telefon för att automatiskt spåra förbipasserande fotgängare.';
  ...
  String get index_1_desc =>
      'Se statistik över fotgängartrafik för valfri tidsperiod.';
  ...
  String get index_2_desc =>
      'Räkna fotgängare, bilar, cyklar och mer samtidigt';
  ...
  String get index_3_desc =>
      'Definiera egna detekteringszoner för att räkna trafik i specifika områden.';
  ...
  String get index_4_desc =>
      'Välj att räkna nya objekt som dyker upp inom detekteringszonen, eller de som står stilla.';
  ...
  String get index_desktop2_desc =>
      'Förutom mobilkameror stöder vi inspelade videofiler, webbkamerainmatning och internet-liveströmmar som RTSP. Detta gör att du kan ansluta till befintliga enheter och omedelbart börja mäta trafikflödet.';
  ...
  @override
  String get app_desc =>
      'Vill du veta hur många människor som passerar förbi? Denna app använder din telefons kamera för att intelligent identifiera och automatiskt räkna fotgängare. Ingen manuell inmatning krävs. Säg farväl till tråkig räkning och övervaka enkelt trafikflödet.';
